...
model_path = "/kaggle/working/spinal_cord_unet(with padding v2).h5"  # Replace with the path to your saved model

# Placeholder for image and label directories
image_dir = "/kaggle/input/spine-segmentation-test/Processed_Scol(test)"  # Replace with your test image directory
label_dir = "/kaggle/input/spine-segmentation-test/Processed_Scol(test)Line"  # Replace with your test label directory
